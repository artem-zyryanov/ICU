...
namespace ICUVideoSecurity.Droid.ICUTechServiceProxy {
    ...
    public partial class IICUTechservice : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public IICUTechservice() {
            this.Url = "http://www.icu-tech.com/isapi/ICUTech.dll/soap/IICUTech";
        }
        
        public IICUTechservice(string url) {
            this.Url = url;
        }
        ...
        [return: System.Xml.Serialization.SoapElementAttribute("return")]
        public string GetCameras(int EntityID, string Username, string Password, int LocationID) {
        ...
        public void GetCamerasAsync(int EntityID, string Username, string Password, int LocationID) {
            this.GetCamerasAsync(EntityID, Username, Password, LocationID, null);
        }
        
        /// CodeRemarks
        public void GetCamerasAsync(int EntityID, string Username, string Password, int LocationID, object userState) {
            ...
            this.InvokeAsync("GetCameras", new object[] {
                        ...
                        Username,
                        Password,
                        LocationID}, this.GetCamerasOperationCompleted, userState);
        }
        ...
        [return: System.Xml.Serialization.SoapElementAttribute("return")]
        public string SetLocation(int EntityID, string Username, string Password, string LocationName, string IP, int Port, int MediaPort, int LocationID) {
        ...
        /// CodeRemarks
        public void SetLocationAsync(int EntityID, string Username, string Password, string LocationName, string IP, int Port, int MediaPort, int LocationID) {
            this.SetLocationAsync(EntityID, Username, Password, LocationName, IP, Port, MediaPort, LocationID, null);
        }
        
        /// CodeRemarks
        public void SetLocationAsync(int EntityID, string Username, string Password, string LocationName, string IP, int Port, int MediaPort, int LocationID, object userState) {
            ...
            this.InvokeAsync("SetLocation", new object[] {
                        ...
                        Port,
                        MediaPort,
                        LocationID}, this.SetLocationOperationCompleted, userState);
        }
        ...
        [return: System.Xml.Serialization.SoapElementAttribute("return")]
        public string SetCamera(int EntityID, string Username, string Password, string LocationName, string URL, int CameraId, int LocationID) {
        ...
        /// CodeRemarks
        public void SetCameraAsync(int EntityID, string Username, string Password, string LocationName, string URL, int CameraId, int LocationID) {
            this.SetCameraAsync(EntityID, Username, Password, LocationName, URL, CameraId, LocationID, null);
        }
        
        /// CodeRemarks
        public void SetCameraAsync(int EntityID, string Username, string Password, string LocationName, string URL, int CameraId, int LocationID, object userState) {
            ...
            this.InvokeAsync("SetCamera", new object[] {
                        ...
                        URL,
                        CameraId,
                        LocationID}, this.SetCameraOperationCompleted, userState);
        }
        ...
        [return: System.Xml.Serialization.SoapElementAttribute("return")]
        public string SetAlarm(int EntityID, string Username, string Password, int Status, int LocationID) {
        ...
        public void SetAlarmAsync(int EntityID, string Username, string Password, int Status, int LocationID) {
            this.SetAlarmAsync(EntityID, Username, Password, Status, LocationID, null);
        }
        
        /// CodeRemarks
        public void SetAlarmAsync(int EntityID, string Username, string Password, int Status, int LocationID, object userState) {
            ...
            this.InvokeAsync("SetAlarm", new object[] {
                        ...
                        Password,
                        Status,
                        LocationID}, this.SetAlarmOperationCompleted, userState);
        }
        ...
        [return: System.Xml.Serialization.SoapElementAttribute("return")]
        public string PushMessage(int EntityID, string Username, string Password, string text, string FunctionPassword, int KindType, int KindID, int LocationId) {
        ...
        /// CodeRemarks
        public void PushMessageAsync(int EntityID, string Username, string Password, string text, string FunctionPassword, int KindType, int KindID, int LocationId) {
            this.PushMessageAsync(EntityID, Username, Password, text, FunctionPassword, KindType, KindID, LocationId, null);
        }
        
        /// CodeRemarks
        public void PushMessageAsync(int EntityID, string Username, string Password, string text, string FunctionPassword, int KindType, int KindID, int LocationId, object userState) {
            ...
            this.InvokeAsync("PushMessage", new object[] {
                        ...
                        KindType,
                        KindID,
                        LocationId}, this.PushMessageOperationCompleted, userState);
        }
        ...
        [return: System.Xml.Serialization.SoapElementAttribute("return")]
        public string SyncCameras(int EntityID, string Username, string Password, int LocationID, int CamerasCount, int[] CameraIds, string[] CameraNames) {
        ...
        /// CodeRemarks
        public void SyncCamerasAsync(int EntityID, string Username, string Password, int LocationID, int CamerasCount, int[] CameraIds, string[] CameraNames) {
            this.SyncCamerasAsync(EntityID, Username, Password, LocationID, CamerasCount, CameraIds, CameraNames, null);
        }
        
        /// CodeRemarks
        public void SyncCamerasAsync(int EntityID, string Username, string Password, int LocationID, int CamerasCount, int[] CameraIds, string[] CameraNames, object userState) {
        ...
        [return: System.Xml.Serialization.SoapElementAttribute("return")]
        public string AddClip(int EntityId, string UserName, string Password, int locationID, int cameraID, int clipID, int ClipLength, string ClipDate) {
        ...
        /// CodeRemarks
        public void AddClipAsync(int EntityId, string UserName, string Password, int locationID, int cameraID, int clipID, int ClipLength, string ClipDate) {
            this.AddClipAsync(EntityId, UserName, Password, locationID, cameraID, clipID, ClipLength, ClipDate, null);
        }
        
        /// CodeRemarks
        public void AddClipAsync(int EntityId, string UserName, string Password, int locationID, int cameraID, int clipID, int ClipLength, string ClipDate, object userState) {
        ...
        [return: System.Xml.Serialization.SoapElementAttribute("return")]
        public string GetClips(int EntityId, string UserName, string Password, int ResultType, int locationID, int cameraID, string DateFrom, string DateTo, int LimitFrom, int LimitTo) {
        ...
        /// CodeRemarks
        public void GetClipsAsync(int EntityId, string UserName, string Password, int ResultType, int locationID, int cameraID, string DateFrom, string DateTo, int LimitFrom, int LimitTo) {
            this.GetClipsAsync(EntityId, UserName, Password, ResultType, locationID, cameraID, DateFrom, DateTo, LimitFrom, LimitTo, null);
        }
        
        /// CodeRemarks
        public void GetClipsAsync(int EntityId, string UserName, string Password, int ResultType, int locationID, int cameraID, string DateFrom, string DateTo, int LimitFrom, int LimitTo, object userState) {
        ...
        [return: System.Xml.Serialization.SoapElementAttribute("return")]
        public string GetClipsCount(int EntityId, string UserName, string Password, int ResultType, int locationID, int cameraID, string DateFrom, string DateTo) {
        ...
        /// CodeRemarks
        public void GetClipsCountAsync(int EntityId, string UserName, string Password, int ResultType, int locationID, int cameraID, string DateFrom, string DateTo) {
            this.GetClipsCountAsync(EntityId, UserName, Password, ResultType, locationID, cameraID, DateFrom, DateTo, null);
        }
        
        /// CodeRemarks
        public void GetClipsCountAsync(int EntityId, string UserName, string Password, int ResultType, int locationID, int cameraID, string DateFrom, string DateTo, object userState) {
